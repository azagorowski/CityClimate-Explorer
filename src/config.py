...
REGIONAL_CAPITALS = DATA_DIR / "preloaded" / "regional_capitals_top90_countries.json"
TOP_90_COUNTRIES_BY_AREA = DATA_DIR / "preloaded" / "top_90_countries_by_area.json"
POLAR_BORDER_CAPITALS = DATA_DIR / "preloaded" / "regional_capitals_polar_border.json"
PRIORITY_REGIONAL_CAPITALS = DATA_DIR / "preloaded" / "regional_capitals_priority_countries.json"
...
MONTHLY_CLIMATE_METRICS_CACHE = DATA_DIR / "preloaded" / "monthly_climate_metrics_cache.json"
